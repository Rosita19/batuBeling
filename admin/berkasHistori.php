                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        ...
                        <div class="col-sm-12 mt-5" style="margin:20px">
                          <table>
                                        <tr>
                                            <td><a href="dataValidasiA.php" style="margin-left : 40px; border-radius:5px;" class="btn btn-success fa fa-arrow-left"></a></td>
                                        </tr>
                                    </table>
                      </div>
                        <div>
                            <?php
                                    ...
                                    $query = "SELECT *FROM histori_verifikasi WHERE idVerif = '".$idVerif."'";
