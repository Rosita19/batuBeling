                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        ...
                        <div class="col-sm-12 mt-5" style="margin:20px">
                          <table>
                                        <tr>
                                            <td><a href="dataPengajuanM.php" style="margin-left : 40px; border-radius:5px;" class="btn btn-success">Kembali</a></td>
                                            <td><a href="cetakSurvey.php" class="btn btn-success" style="margin-left: 40px; border-radius: 5px;"><i class="fa fa-print"></i> Download PDF</a></td>
                        ...
                        <div>
                            <?php
                                   ...
                                   while($data = mysqli_fetch_array($sql)){
                                    ?>
                                    <?php echo "<center><img style='width: 500px; margin:50px; align: center;' src='gambar/$data[nama]' /></center>";?>
