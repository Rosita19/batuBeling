                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-10">Preview Gambar KTP</h3>
                        </div>
                        <div class="col-sm-12 mt-5" style="margin:20px">
                          <table>
                                        <tr>
                                            <td><a href="dataPengajuanA.php" style="margin-left : 40px; border-radius:5px;" class="btn btn-success">Kembali</a></td>
                                        </tr>
                                    </table>
                      </div>
                        <div>
                            <?php
                                    ...
                                    // echo "<td><img style='width: 400px; margin:50px; align: center;' src='../admin/gambar/$data[nama]' /></td>";
                                    // echo "<td></td>";
                                    // echo "<td><img style='width: 400px; margin:50px; align: center;' src='../admin/gambar/$data[nama2]' /></td>";
                                    // echo "<td><img style='width: 400px; margin:50px; align: center;' src='../admin/gambar/$data[nama3]' /></td>";
                                    // echo "<td><img style='width: 400px; margin:50px; align: center;' src='../admin/gambar/$data[nama4]' /></td>";
                                    // echo "<td><img style='width: 400px; margin:50px; align: center;' src='../admin/gambar/$data[nama5]' /></td>";
                                    // echo "<tr>";
                            ?>
                            <div class="row g-4" style="margin-left:50px;">
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar KTP:</strong> <a href="editKTP.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success" style="margin-left: 40px; border-radius:5px"><i class="fa fa-edit"></i></a></label>
                                    <?php echo "<img style='width: 450px; height: 350px; align: center;' src='../admin/gambar/$data[nama]' />";?>

                                </div>
                                
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar KK:</strong> <a href="editKK.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success" style="margin-left: 40px; border-radius:5px"><i class="fa fa-edit"></i></a></label>
                                    <?php echo "<img style='width: 450px; height: 350px; align: center;' src='../admin/gambar/$data[nama2]' />";?>

                                </div>
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar Jamaah :</strong> <a href="editKK.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success" style="margin-left: 40px; border-radius:5px"><i class="fa fa-edit"></i></a></label>
                                    <?php echo "<img style='width: 450px; height: 350px; align: center;' src='../admin/gambar/$data[nama3]' />";?>

                                </div>
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar Rumah Dari Depan:</strong> <a href="editKK.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success" style="margin-left: 40px; border-radius:5px"><i class="fa fa-edit"></i></a></label>
                                    <?php echo "<img style='width: 450px; height: 350px; align: center;' src='../admin/gambar/$data[nama4]' />";?>

                                </div>
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar Toilet:</strong> <a href="editKK.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success" style="margin-left: 40px; border-radius:5px"><i class="fa fa-edit"></i></a></label>
