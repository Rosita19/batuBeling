...
<center><b>DATA DONASI</center>
<hr><width="100" height="75"></hr>
<center>
    <h2>Data Donasi Selain Uang</h2>
</center>
<?php
include 'koneksi.php';
?>
          ...
          <table cellpadding="5" cellspacing="0" border="1" width="100%">
            ...
            <?php
           $sql = mysqli_query($konek, "select *from donasilain ");
           $no = 1;
           while($data = mysqli_fetch_array($sql)){
            ...
            <td><?= $data['jumlah']?></td>
            <td><?= $data['nomer']?></td>
            <td><?= $data['pilih_bank']?></td>
            <td><?php echo "<img src='gambar/$data[gambar]' />";?></td></td>
