                    ...
                    <div id="page-content">
                     <div class="panel" style="border-radius: 10px;">
                            <div class="panel-heading">
                                <h3 class="panel-title">Jenis Bantuan Gratis</h3>
                            </div>
                            ...
                            <div class="card-body">
                                <form action="cariHasil.php" method="get">
                                <center>
                                ...
                                <div class="table-responsive">
                                    ...
                                    $query = "SELECT * FROM verifikasi where jenisBantuan ='Gratis'";
                                    ...
                                    while($data = mysqli_fetch_array($sql)){
                                      ...
                                      echo "<td><a class='btn btn-primary fa fa-image' style='border-radius: 5px;' href='cetakKartu.php?idPengajuan=".$data['idPengajuan']."'></a></td>";
                                      ...
                                      echo "<td><a class='btn btn-success fa fa-edit' style='border-radius: 5px;' href='masaPendaftar.php?idVerif=".$data['idVerif']."'></a></td>";  
                                      echo "<tr>";  
                                      $no++;
                                  }?>
                                ...
                                <div class="row" style="margin-bottom: 20px;">
                                    ...
                                    <table>
                                        <tr>
                                            <td><a href="cetakLaporan.php" class="btn btn-success" style="margin-left: 40px; border-radius:5px"><i class="fa fa-print"></i> Laporan Rekapitulasi</a></td>
                                            <td><a href="cetak.php" class="btn btn-success" style="margin-left: 40px; border-radius:5px"><i class="fa fa-print"></i> Data Pengajuan</a></td>
                                            <td><a href="valid.php" class="btn btn-success" style="margin-left: 40px; border-radius: 5px;"><i class="fa fa-print"></i> List Survey</a></td>
                                            <td><a href="excell.php" class="btn btn-success" style="margin-left: 40px; border-radius: 5px;"><i class="fa fa-print"></i> Download Excell</a></td>
                                        </tr>
                                    </table>
                                    ...
                                    <ul id="mainnav-menu" class="list-group">
                                        ...
                                        <li>
                                            ...
                                            <ul class="collapse">
                                                ...
                                                <li><a href="validasi.php"><i class="fa fa-caret-right"></i> Validasi Data </a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">
                                            ...
                                            <!--Submenu-->
                                            <ul class="collapse">
                                                <li><a href="tahap1.php"><i class="fa fa-caret-right"></i> Lolos Tahap 1 </a></li>
                                                <li><a href="tahap2.php"><i class="fa fa-caret-right"></i> Lolos Tahap 2 </a></li>
                                                <li><a href="hasil.php"><i class="fa fa-caret-right"></i> Hasil Akhir </a></li>
                                            </ul>
                                        </li>
                                        <!--Menu list item-->
                                        <li>
                                         ...
                                         <li>
                                            ...
                                            <!--Submenu-->
                                            <ul class="collapse">
                                                <li><a href="dataPending.php"><i class="fa fa-caret-right"></i> Data Pending </a></li>
                                                <li><a href="dataLolos.php"><i class="fa fa-caret-right"></i> Data Lolos </a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">
                                            ...
                                            <!--Submenu-->
                                            <ul class="collapse">
                                                <li><a href="dataAbsen.php"><i class="fa fa-caret-right"></i> Data Absen</a></li>
