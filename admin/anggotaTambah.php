...
<html lang="en">
    ...
    <body>
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Data Anggota Keluarga</h3>
                        </div>
            ...
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Nama Pengaju:</strong></label>
                <input type="text" class="form-control" name="namaPengajuan" value="<?= $data['namaPengaju']?>" id="umum" required>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Jumlah KK satu rumah:</strong></label>
                <input type="text" class="form-control" name="jumlahKK" value="<?= $data['jumlahKK']?>" id="umum" required>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Jumlah Anggota Satu rumah :</strong></label>
                <input type="text" class="form-control" name="jumlahAnggota" value="<?= $data['jumlahAnggota']?>" id="umum" required>
            </div>
        ...
        <br>
          <form action="prosesAnggota.php" method="post">
            ...
            <input type="hidden" class="form-control" name="idPengajuan" id="umum" value="<?php echo $data['idPengajuan'];?>">
                
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Nama Anggota Keluarga:</strong></label>
                <input type="text" class="form-control" name="namakeluarga[]" id="umum" required>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Pekerjaan:</strong></label>
                <input type="text" class="form-control" name="pekerjaanKeluarga[]" id="umum" required>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Penghasilan:</strong></label>
                <input type="text" class="form-control" name="penghasilan[]" id="umum" required>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Status Anggota Keluarga:</strong></label>
                <input type="text" class="form-control" name="statusKeluarga[]" id="umum" required>
                <p style="font-size:10px">*Sebagai Istri, Anak, Suami</p>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Kondisi Fisik:</strong></label>
                <input type="text" class="form-control" name="kondisiFisik[]" id="umum" required>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Riwayat Penyakit:</strong></label>
                <input type="text" class="form-control" name="riwayatPenyakit[]" id="umum" required>
            </div>
            <hr>
            </div>
