                    ...
                    <div id="page-content">
                     <div class="panel">
                            ...
                            <div style="width: 95%; border-radius: 5px; padding:20px; margin:20px" >
                                <form action="cobakan.php" method="get">
                            ...
                            <div class="col-auto">
                                ...
                                <div class="table-striped">
                                    <table border="1" class="table table-striped" id="dataTable" style="margin-left: 30px; margin-right: 30px; width: 80%">
                                    <thead>
                                        <tr>
                                            <th class="text-center"cellspa style="background-color:#009900; color:white">Bulan - Tahun Absen</th>
                                            <td><?= $bln."-".$thn?></td>
                                        ...
                                        <tr>
                                            ...
                                            echo "<tr>";
                                            ?>
                                            <th class="text-center"cellspa style="background-color:#009900; color:white; margin:5px;">Tahap <?php echo $tahap;?></th>
                                            

                                            <?php
                                            $pip = mysqli_num_rows($ok);
                                            
                                            

                                             if ($data["status"] == 'Diambil'){
                                            echo "<td><a class='btn btn-primary fa fa-check' style='border-radius: 5px;'>".$data['tglAbsen']." | " .$data['ket']." | " .$data['status']."</a></td>";


                                            }else{
                                                echo "<td><a class='btn btn-warning fa fa-check' style='border-radius: 5px;'>".$data['tglAbsen']." | " .$data['ket']." | " .$data['status']."</a></td>";
                                            }
                                         }
                                    
                                   
                                      // if ($data["status"] == 'Diambil'){
                                      //       echo "<td><a class='btn btn-primary fa fa-check' style='border-radius: 5px;'></a></td>";
                                ...
                                <div class="col-lg-3">        
                                        <a href="dataAbsenA.php" class="btn btn-success" style="margin-left: 40px; border-radius:5px">Kembali</a>
                                    </div>
                                <!-- <table border="1">
                                    <tr>
                                        <td>Bulan tahun</td>
