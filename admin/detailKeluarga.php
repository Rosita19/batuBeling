                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Tambah Pengajuan</h3>
                        </div>
                        ...
                        <div class="col-sm-12 mt-5">
                         <div class="col-sm-12 mt-5" style="margin:5px">
                            ...
                            $query = "select *from verifikasi order by idPengajuan DESC limit 1";
                            $sql = mysqli_query($konek, $query);
                            $data = mysqli_fetch_array($sql); 
                        ?> 
                            <div class="section-title">
                              <h3 class="text-center">Data Berhasil Di Ubah!!</h3>
                              <center>
                                <table width="50%" style="font-family: times new roman; font-size: 25px; margin:10px" class="table table-striped" border="3">
                                    <tr>
                                        <th>ID</th>
                                        <th>:</th>
                                        <th><?= $data['idPengajuan']?></th>  
                                    </tr>
                                    <tr>
                                        <th>Nama Pengaju</th>
                                        <th>:</th>
                                        <th><?= $data['namaPengaju']?></th>
                                    </tr>
                                    <tr>
                                        <th>Jumlah KK Dalam Satu Rumah</th>
                                        <th>:</th>
                                        <th><?= $data['jumlahKK']?></th>
                                    </tr>
                                    <tr>
                                        <th>Jumlah Anggota Dalam Satu Rumah</th>
                                        <th>:</th>
                                        <th><?= $data['jumlahAnggota']?></th>
                                    </tr>

                                    
                                </table><br>
                                <p style="font-size:20px; font-family:times new roman; color: red"><i>Apakah ada perubahan pada data anggota keluarga? jika ya maka klik lanjut!. jika tidak maka klik icon kembali!!</p>
                                <a href="tahap1A.php" style="margin-left : 40px; border-radius:5px; height: 30px;" class="btn btn-success fa fa-arrow-left"></a>
                                <a href="editkeluarga.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success" style="margin-left: 40px; border-radius:5px">Lanjut</a>
