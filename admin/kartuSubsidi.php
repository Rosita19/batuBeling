...
<html lang="en">
    ...
    <style>
        ...
        .depan {
            background-image: url('img/depanSubsidi.jpg');
            width: 600px;
            height : 380px;
                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Preview Kartu Subsidi</h3>
                        </div>
                        ...
                        ?>
                          <table>
                                        <tr>
                                            <td><a href="hasilA.php" style="margin-left : 40px; border-radius:5px;" class="btn btn-success fa fa-arrow-left"></a>
                                             <a href="subsidiAPdf.php?idPengajuan=<?= $data['idPengajuan']?>" target="_blank" name="view" class="btn btn-success" style="margin-left: 5px; border-radius:5px"><i class="fa fa-file-pdf-o"></i></td>
    ...
    <div class="row" style="margin-left: 200px;">
            ...
            <div class="col-md-4">
                <div class="depan">
                <?php echo "<img src='../admin/gambar/$data[nama]'; class='poto'/>";?>
                </div>
            </div>
            <div class="col-md-6">
                <table style="margin-top:175px; margin-left: 40px; color:white; font-size: 16px;">
                    <tr>  
                        <th style="margin-top:50px"><?= $data['namaPengaju']?></th>
                    </tr>
                </table>
                <table style="margin-top:14px; margin-left: 40px; color:white; font-size: 16px;">
                    <tr>  
                        <th style="text-align: center;">NIK :</th>
                        
                    </tr>
                    <tr>
                        <th style="margin-top:50px"><?= $data['nik']?></th>
                    </tr>
                </table>
                <table style="margin-top:14px; margin-left: 10px; color:white; font-size: 16px;">
                    <tr>  
                        <th style="text-align: center;">Alamat :</th>
                        
                    </tr>
                    <tr>
                        <td style="margin-top:50px"><?= $data['alamatD']?></td>
                    </tr>
                </table>
        ...
        <div class="col-md-12" style="margin-top:20px">
            <div class="col-md-5">
                <img src="img/belakangberas.jpeg" alt="" class="belakang">
