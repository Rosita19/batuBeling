                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Data Keluarga</h3>
                        </div>
                      ...
                      <?php
                                ...
                                $query = "SELECT *FROM keluarga inner join pengajuan WHERE keluarga.idPengajuan=pengajuan.idPengajuan";
                                $sql = mysqli_query($konek, $query);
                                $data = mysqli_fetch_array($sql); 
                            ?>
                        <div class="col-sm-12 mt-5">
                         <div class="col-sm-12 mt-5" style="margin:5px">
                        <form action="proses_editKeluarga.php?idKeluarga=<?php echo $idKeluarga; ?>" method="post" enctype="multipart/form-data">
                               
                            <div class="table-responsive">

                                    
                                <div class="col-md-4">
                                    <label class="control-label col-sm-8 mb-2"><strong>Nama Keluarga:</strong></label>
                                    <input type="text" class="form-control" name="namakeluarga" value="<?php echo $data['namakeluarga'];?>" id="umum" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="control-label col-sm-8 mb-2"><strong>Pekerjaan:</strong></label>
                                    <input type="text" class="form-control" name="pekerjaanKeluarga" value="<?php echo $data['pekerjaanKeluarga'];?>" id="umum" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="control-label col-sm-8 mb-2"><strong>Penghasilan:</strong></label>
                                    <input type="text" class="form-control" name="penghasilan" value="<?php echo $data['penghasilan'];?>" id="umum" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="control-label col-sm-12 mb-2"><strong>Status Keluarga:</strong></label>
                                    <input type="text" class="form-control" name="statusKeluarga" value="<?php echo $data['statusKeluarga'];?>" id="umum" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="control-label col-sm-12 mb-2"><strong>Kondisi Fisik</strong></label>
                                    <textarea type="text" class="form-control" name="kondisiFisik" id="umum" required><?php echo $data['kondisiFisik'];?></textarea>
                                </div>
                                <div class="col-md-4">
                                    <label class="control-label col-sm-8 mb-2"><strong>Riwayat Penyakit:</strong></label>
                                    <textarea type="text" class="form-control" name="riwayatPenyakit" id="umum" required><?php echo $data['riwayatPenyakit'];?></textarea>
                                </div>
                                    ...
                                    <div class="col-md-12" style="margin-top:10px">
                                        ...
                                        <a href="editKeluarga.php" class="btn btn-success">Batal</a>
                                    </div>  
                            </div>
                        </form>
