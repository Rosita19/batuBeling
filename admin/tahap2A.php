                    ...
                    <div id="page-content">
                     <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Data Selesai Survey</h3>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    $query2 = "SELECT * FROM verifikasi limit $mulai, $hal";
                                    ...
                                    while($data = mysqli_fetch_array($sql2)){
                                      ...
                                      if ($data["perubahan"] == 'Ada Perubahan'){
                                            echo "<td><a class='btn btn-warning fa fa-check' style='border-radius: 5px;'>".$data['perubahan']."</a></td>";
                                        }else{
                                            echo "<td><a class='btn btn-primary fa fa-check' style='border-radius: 5px;'>".$data['perubahan']."</a></td>";
                                        }
                                      ...
                                      echo "<td><a class='btn btn-success fa fa-edit' style='border-radius: 5px;' href='kriteriaA.php?idVerif=".$data['idVerif']."'></a></td>";  
                                ...
                                <div style="margin-left:40px; margin-bottom: 10px; margin-top: 20px;">
                                    ...
                                    for ($i=1; $i<=$pages ; $i++) { ?>
                                     ...
                                     <a href="tahap2A.php?hal=<?php echo $i; ?>" style="text-decoration:none" class="btn btn-default">   <u><?php echo $i; ?></u></a>
                                     <?php
                                    }
                                ?>
                                </div>
