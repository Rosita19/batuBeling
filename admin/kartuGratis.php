...
<html lang="en">
    ...
    <style>
        ...
        .depan {
            background-image: url('img/depanGratis.jpg');
            width: 600px;
            height : 380px;
                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Preview Kartu Gratis</h3>
                        </div>
                        ...
                        ?> 
                          <table>
                                        <tr>
                                            ...
                                            <a href="gratisAPdf.php?idPengajuan=<?= $data['idPengajuan']?>" target="_blank" name="view" class="btn btn-success" style="margin-left: 5px; border-radius:5px"><i class="fa fa-file-pdf-o"></i></a></td>
                                        </tr>
                                    </table>
                      </div>
                      </div>
