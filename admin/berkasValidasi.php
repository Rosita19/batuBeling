                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-10">Kumpulan Gambar Upload</h3>
                        </div>
                        <div class="col-sm-12 mt-5" style="margin:20px">
                          <table>
                                        <tr>
                                            <td><a href="dataPengajuanA.php" style="margin-left : 40px; border-radius:5px;" class="btn btn-success fa fa-arrow-left"></a></td>
                                        </tr>
                                    </table>
                      </div>
                        <div>
                            ...
                            <div class="row g-4" style="margin-left:50px;">
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar KTP:</strong><a href="editKTP.php?idPengajuan=<?= $data['idPengajuan']?>" style="margin-left : 5px; border-radius:5px;" class="btn btn-success fa fa-edit"></a></label>
                                ...
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar KK:</strong> <a href="editKK.php?idPengajuan=<?= $data['idPengajuan']?>" style="margin-left : 5px; border-radius:5px;" class="btn btn-success fa fa-edit"></a></label>
                                    <?php echo "<img style='width: 450px; height: 350px; align: center;' src='../admin/gambar/$data[nama2]' />";?>

                                </div>
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar Jamaah :</strong> <a href="editJamaah.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success fa fa-edit"></a></label>
                                    <?php echo "<img style='width: 450px; height: 350px; align: center;' src='../admin/gambar/$data[nama3]' />";?>

                                </div>
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar Rumah Dari Depan:</strong> <a href="editRumah.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success fa fa-edit"></a></label>
                                    <?php echo "<img style='width: 450px; height: 350px; align: center;' src='../admin/gambar/$data[nama4]' />";?>

                                </div>
                                <div class="col-md-6">
                                    <label class="control-label col-sm-8 mb-2"><strong>Gambar Toilet:</strong> <a href="editToilet.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success fa fa-edit"></a></label>
