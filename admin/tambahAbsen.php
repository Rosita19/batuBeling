...
<html lang="en">
    ...
    <body>
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 20px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Form Absen</h3>

            <form action="prosesAbsen.php" enctype="multipart/form-data" method="post">
            <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2">Nama Pengaju:</label>
                    <select class="form-control" name="namaPengaju">
                        <option>Nama Pengaju</option>
                        <?php 
                        include 'koneksi.php';
                        $sql = mysqli_query($konek,"select *from verifikasi where statusPendaftar = 'Aktif'");
                        while ($data = mysqli_fetch_array($sql)) {
                         ?>
                         <option><?= $data['namaPengaju']; ?></option>
                        <?php } ?>
                    </select>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2">Keterangan:</label>
            ...
            <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2">Status Beras:</label>
            ...
            <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2">Tanggal Absen:</label>
                <input type="date" name="tglAbsen" class="form-control">
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2">Tahapan Pengambilan:</label>
                <select class="form-control" name="tahap"> 
                    <option>Pilih Tahapan</option>
                    <option value="Pengambilan 1">Pengambilan 1</option>
                    <option value="Pengambilan 2">Pengambilan 2</option>
                </select>
            </div>
            <div class="col-sm-12">
                <br>
                <div class="form-group ml-4">
                    ...
                    <a href="dataAbsenA.php" class="btn btn-success">Batal</a>
                </div>
            </div>               
            </div>
        </form>
