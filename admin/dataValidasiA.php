                    ...
                    <div id="page-content">
                     <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Data Histori Validasi</h3>
                            </div>
                            ...
                            <form action="cariHistoriA.php" method="get">
                                <center>
                            ...
                            <div style="width: 95%; border-radius: 5px; padding:20px; margin:20px" >
                                <div class="row g-4">
                                
                                    <form action="dataValidasiA.php" method="get">
                                    <div class="col-md-6">
                                        <label class="control-label col-sm-8 mb-2"><strong>Periode :</strong></label>
                            ...
                            <a href="dataPengajuanA.php" style="margin-left : 40px; border-radius:5px; height: 30px;" class="btn btn-success fa fa-arrow-left"></a>
                                <div class="table-responsive">
                                    <table border="0" class="table" id="table1" style="text-align:center ;">
                               

                                <div class="table-striped">
                                    <table class="table table-striped table-sm" id="dataTable" width="50%" style="margin-left: 30px; margin-right: 30px;">
                                    <thead>
                            ...
                            if(isset($_GET['dari']) && isset($_GET['ke'])){
                                $data = mysqli_query($konek, "SELECT * FROM histori_verifikasi WHERE tglVerif and tglVerif_baru BETWEEN '".$_GET['dari']."' and '".$_GET['ke']."'");
                            ...
                            while($d = mysqli_fetch_array($data)){
                                echo "<tr>";
                                      echo "<td>".$no."</td>";
                                      echo "<td>".$d['idPengajuan']."</td>";
                                      echo "<td>".$d['namaPengaju']."</td>";
                                      echo "<td>".$d['nik']."</td>";
                                      echo "<td>".$d['alamatD']."</td>";
                                      echo "<td>".$d['pengaju']."</td>";
                                      echo "<td>".$d['tglPengajuan']."</td>";
                                      echo "<td>".$d['tglVerif']."</td>";
                                      
                                       if ($d["status"] == 'Proses'){
                                            echo "<td><a class='btn btn-info fa fa-check' style='border-radius: 5px;'>".$d['status']."</a></td>";

                                        }elseif ($d["status"] == 'Lanjut Survey') {
                                            echo "<td><a class='btn btn-success fa fa-check' style='border-radius: 5px;'>".$d['status']."</a></td>";
                                        }else{
                                            echo "<td><a class='btn btn-warning fa fa-check' style='border-radius: 5px;'>".$d['status']."</a></td>";
                                        }
                                      
                                      if ($d["statusM"] == 'Proses'){
                                            echo "<td><a class='btn btn-info fa fa-check' style='border-radius: 5px;'>".$d['statusM']."</a></td>";

                                        }elseif ($d["statusM"] == 'Lanjut Survey') {
                                            echo "<td><a class='btn btn-success fa fa-check' style='border-radius: 5px;'>".$d['statusM']."</a></td>";
                                        }else{
                                            echo "<td><a class='btn btn-warning fa fa-check' style='border-radius: 5px;'>".$d['statusM']."</a></td>";
                                        }
                                      
                                      if ($d["statusA"] == 'Proses'){
                                            echo "<td><a class='btn btn-info fa fa-check' style='border-radius: 5px;'>".$d['statusA']."</a></td>";

                                        }elseif ($d["statusA"] == 'Lolos Tahap 1') {
                                            echo "<td><a class='btn btn-success fa fa-check' style='border-radius: 5px;'>".$d['statusA']."</a></td>";
                                        }else{
                                            echo "<td><a class='btn btn-warning fa fa-check' style='border-radius: 5px;'>".$d['statusA']."</a></td>";
                                        }
                                      if ($d["perubahan"] == 'Ada Perubahan'){
                                            echo "<td><a class='btn btn-warning fa fa-check' style='border-radius: 5px;'>".$d['perubahan']."</a></td>";
                                        }else{
                                            echo "<td><a class='btn btn-primary fa fa-check' style='border-radius: 5px;'>".$d['perubahan']."</a></td>";
                                        }
                                      
                                      echo "<td><a class='btn btn-primary fa fa-image' style='border-radius: 5px;' href='validasiHistoriA.php?idVerif=".$d['idVerif']."'></a></td>"; 
                                      echo "<td><a class='btn btn-dark fa fa-edit' style='border-radius: 5px;' href='validasiHistoriLagi.php?idVerif=".$d['idVerif']."'></a></td>"; 
