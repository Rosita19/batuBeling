                     ...
                     <div class="panel">
                            ...
                            <div style="width: 95%; border-radius: 5px; padding:20px; margin:20px" >
                                ...
                                <?php
                                  include 'koneksi.php';
                                ?>
                                <a href="dataValidasiA.php" style="margin-left : 40px; border-radius:5px; height: 30px;" class="btn btn-success fa fa-arrow-left"></a>
                                <div class="table-responsive">
                                    ...
                                    <?php 
                                        if (isset($_GET['cari'])) {
                                            $cari = $_GET['cari'];
                                            $sql = "select * from histori_verifikasi where nik like '%".$cari."%' or namaPengaju like '%".$cari."%' or tglVerif like '%".$cari."%' or tglVerif_baru like '%".$cari."%'";
                                            ...
                                            $no = 1;
                                                  ...
                                                  echo "<td><a class='btn btn-primary fa fa-image' style='border-radius: 5px;' href='validasiHistoriA.php?idVerif=".$data['idVerif']."'></a></td>"; 
                                                  echo "<td><a class='btn btn-dark fa fa-edit' style='border-radius: 5px;' href='validasiHistoriLagi.php?idVerif=".$data['idVerif']."'></a></td>";
