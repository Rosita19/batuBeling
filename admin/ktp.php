                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        ...
                        <div class="col-sm-12 mt-5" style="margin:20px">
                          <table>
                                        <tr>
                                            <td><a href="dataPengajuan.php" style="margin-left : 40px; border-radius:5px;" class="btn btn-success">Kembali</a></td>
                        ...
                        <div>
                            <?php
                                   ...
                                   $data = mysqli_fetch_array($sql);
                                    ...
                                    echo "<center><img style='width: 500px; margin:50px; align: center;' src='gambar/$data[nama]' /></center>";
                                    ?>
                        </div>
