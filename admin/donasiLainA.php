                    ...
                    <div id="page-content">
                     <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Data Donasi Lain</h3>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT * FROM donasilain";
                                        $sql = mysqli_query($konek, $query);
                                        $total = mysqli_num_rows($sql);
                                        $pages = ceil($total/$hal);

                                        $query2 = "SELECT * FROM donasilain limit $mulai, $hal";
                                        ...
                                        while($data = mysqli_fetch_array($sql2)){
                                          ...
                                          echo "<td>".$data['jenis_donasi']."</td>";
                                          echo "<td>".$data['jumlah']."</td>";
                                          echo "<td>".$data['nomer']."</td>";
                                          
                                          echo "<td><a class='btn btn-primary fa fa-image' style='border-radius: 5px;' href='buktiLainA.php?idDonasi=".$data['idDonasi']."'></a></td>";
                                          echo "<tr>";  
                                      }?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">        
                                        <a href="cetakDonasiLainA.php" class="btn btn-success" style="margin-left: 40px; border-radius:5px"><i class="fa fa-print"></i> Cetak</a>
                                    </div>
                                </div>
                                <div style="margin-left:40px; margin-bottom: 10px; margin-top: 20px;">
                                    ...
                                    for ($i=1; $i<=$pages ; $i++) { ?>
                                     ...
                                     <a href="donasiLainA.php?hal=<?php echo $i; ?>" style="text-decoration:none"><div class="btn btn-default">   <u><?php echo $i; ?></u></a>
                                     <?php
                                    }
                                ?>
                                </div>
