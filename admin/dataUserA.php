                ...
                <div id="content-container">
                    ...
                    <div id="page-content">
                     <div class="panel">
                            ...
                            <div class="card-body">
                                <a href="tambahUser.php" class="btn btn-primary" style="margin-left: 40px; margin-top:10px; margin-right: 20px; border-radius:5px;"><i class="fa fa-plus"></i> Add</a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php
                                        ...
                                        while($data = mysqli_fetch_array($sql)){
                                          ...
                                          echo "<td><a class='btn btn-danger fa fa-trash' style='border-radius: 5px;' href='hapusUser.php?id=".$data['id']."'></a></td>";
                                          echo "<td><a class='btn btn-success fa fa-edit' style='border-radius: 5px;' href='ubahUser.php?id=".$data['id']."'></a></td>";
                                          echo "<tr>"; 
                                          $no++; 
                                      }?>
