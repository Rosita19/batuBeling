...
<html lang="en">
                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Pengubahan Status Pengaju</h3>
                            <?php
                                include "koneksi.php";
    ...
    <form action="proses_masa.php?idVerif=<?php echo $idVerif; ?>" method="post" enctype="multipart/form-data">  
      ...
      <div style="width: 95%; height: 400px; border-radius: 5px; background: #ecf0f1; padding:20px; margin:20px" >
        <div>
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-8">
                <label class="control-label col-sm-8 mb-2"><strong>Status Pengaju:</strong></label>
                <select class="form-control" name="statusPendaftar" required> 
                    <option>Pilih</option>
            ...
            <div class="col-sm-12 mt-5" style="margin-top:15px;">
                     <div class="form-group ml-4">
                        ...
                        <a href="hasilA.php" class="btn btn-success">Batal</a>
                      </div>
                  </div>
        </div>
    </div>
