                    ...
                    <div id="page-content">
                     <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Kumpulan Data Lolos Tahap 1</h3>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    $query = "SELECT * FROM pengajuan WHERE statusA = 'Lolos Tahap 1'";
                                    $sql = mysqli_query($konek, $query);
                                    $total = mysqli_num_rows($sql);
                                    $pages = ceil($total/$hal);

                                    $query2 = "SELECT * FROM pengajuan WHERE statusA = 'Lolos Tahap 1' limit $mulai, $hal";
                                    ...
                                    while($data = mysqli_fetch_array($sql2)){
                                     ...
                                     echo "<td><a class='btn btn-primary fa fa-image' style='border-radius: 5px;' href='berkas.php?idPengajuan=".$data['idPengajuan']."'></a></td>"; 
                                      echo "<td><a class='btn btn-dark fa fa-edit' style='border-radius: 5px;' href='validasiDataA.php?idPengajuan=".$data['idPengajuan']."'></a></td>"; 
                    
                                      echo "<tr>";  
                                  }?>

                                </table>
                                <div style="margin-left:40px; margin-bottom: 10px; margin-top: 20px;">
                                    <p><b>Page</b> </p>
                                    <?php
                                    for ($i=1; $i<=$pages ; $i++) { ?>
                                        
                                     <a href="tahap1A.php?hal=<?php echo $i; ?>" style="text-decoration:none" class="btn btn-default">   <u><?php echo $i; ?></u></a>
                                     <?php
                                    }
                                ?>
                                </div>
