                     ...
                     <div class="panel">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row" style="margin-bottom: 20px;">
                                    <table>
                                        <tr>
                                            <td><a href="tambahPengajuanA.php" class="btn btn-primary" class="btn btn-success" style="margin-left: 30px; border-radius:5px"><i class="fa fa-plus"></i> Add</a></td>
                                            <td><a href="cetak.php" target="_blank" name="view" class="btn btn-success" style="margin-left: 5px; border-radius:5px"><i class="fa fa-file-pdf-o"></i></a></td>
                                            <td><a href="word.php" class="btn btn-success" style="margin-left: 5px; border-radius: 5px;"><i class="fa fa-file-word-o"></i></a></td>
                                            
                                            <td><a href="excell.php" class="btn btn-success" style="margin-left: 5px; border-radius: 5px;"><i class="fa fa-file-excel-o"></i></a></td>
                                        </tr>
                                    </table>
                                </div>
                                </form>
                                ...
                                <div class="table-responsive">
                                    ...
                                    $query2 = "SELECT * FROM pengajuan limit $mulai, $hal";
                                    ...
                                    while($data = mysqli_fetch_array($sql2)){
                                      ...
                                      if ($data["statusA"] == 'Proses'){
                                        ...
                                        }elseif ($data["statusA"] == 'Lanjut Survey') {
                                ...
                                <div style="margin-left:40px; margin-bottom: 10px; margin-top: 20px;">
                                    ...
                                    for ($i=1; $i<=$pages ; $i++) { ?>
                                     ...
                                     <a href="dataPengajuanA.php?hal=<?php echo $i; ?>" style="text-decoration:none;"><div class="btn btn-default"><?php echo $i; ?></div></a>
                                     <?php
                                    }
                                ?>
                                </div>
