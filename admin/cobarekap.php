                    ...
                    <div id="page-content">
                     <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Data Absen</h3>
                            </div>
                            ...
                            <?php
                                ...
                                $query = "SELECT *FROM absen WHERE namaPengaju = '".$namaPengaju."'";
                                $sql = mysqli_query($konek, $query);
                                $data = mysqli_fetch_array($sql); 

                                $ok = mysqli_query ($konek,"select MONTH(tglAbsen) as bulan,YEAR(tglAbsen) as tahun from absen where status='Diambil';");
                                $okk = mysqli_fetch_array($ok);
                            ...
                            <div class="table-responsive">
                                    <table border="1" class="table table-striped" id="dataTable" width="100%" style="margin-left: 30px; margin-right: 30px;">
                                        <tr>
                                            <th>Bulan - Tahun Absen</th>
                                        </tr>
                                        <tr>
                                            <th>Tahap 1</th>
                                        </tr>
                                    ...
                                    <ul id="mainnav-menu" class="list-group">
                                        ...
                                        <li>
                                            ...
                                            <ul class="collapse">
                                                ...
                                                <li><a href="pengajuan.php"><i class="fa fa-caret-right"></i> Pengajuan Data </a></li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="collapse">
                                                ...
                                                <li><a href="hasilAkhir.php"><i class="fa fa-caret-right"></i> Hasil Akhir </a></li>
                                            </ul>
                                        </li>
                                        <!--Menu list item-->
                                        <li>
                                         ...
                                         <li>
                                            ...
                                            <!--Submenu-->
                                            <ul class="collapse">
                                                <li><a href="dataPending1.php"><i class="fa fa-caret-right"></i> Pending Tahap 1 </a></li>
                                                <li><a href="dataPending2.php"><i class="fa fa-caret-right"></i> Pending Tahap 2 </a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">
                                            ...
                                            <ul class="collapse">
                                                ...
                                                <li><a href="rekapAbsen.php"><i class="fa fa-caret-right"></i> Rekap Absen</a></li>
                                                <li><a href="fileAbsenG.php"><i class="fa fa-caret-right"></i> File Absen Gratis </a></li>
                                                <li><a href="fileAbsen.php"><i class="fa fa-caret-right"></i> File Absen Subsidi</a></li>
                                            </ul>
                                        </li>
                                        <!--Menu list item-->
