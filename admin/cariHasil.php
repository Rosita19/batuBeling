                    ...
                    <div id="page-content">
                     <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Data Penentu Kriteria</h3>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <input type="submit" value="Search" class="browse btn btn-success" style="margin-top:0px; margin-left: 650px; margin-top:  ;"></center>
                                ...
                                <div class="table-responsive">
                                    ...
                                    if (isset($_GET['cari'])) {
                                    $cari = $_GET['cari'];
                                    $sql = "select * from verifikasi where namaPengaju like '%".$cari."%' or nik like '%".$cari."%' or jenisBantuan like '%".$cari."%'";
                                    ...
                                    $no = 1;
                                      ...
                                      echo "<td><a class='btn btn-success fa fa-edit' style='border-radius: 5px;' href='kriteria.php?idVerif=".$data['idVerif']."'></a></td>";  
                                      echo "<tr>";  
                                      $no++;
                                  }
                              ?>
