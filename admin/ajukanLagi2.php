...
<html lang="en">
                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Validasi Data Pengajuan</h3>
                            <?php
                                include "koneksi.php";
    ...
    <form action="prosesajukan2.php" method="post" enctype="multipart/form-data">  
    
      <div style="width: 95%; height: 1200px; border-radius: 5px; background: #ecf0f1; padding:20px; margin:20px" >
        <div>
          ...
          <?php
            ...
            $sql = "select max(idPengajuan) from pengajuan";
            $query = mysqli_query($konek, $sql);
            $kode_petugas = mysqli_fetch_array($query);

            if($kode_petugas){
                $nilai = substr($kode_petugas[0], 1);
                $kode = (int)$nilai;
        ...
        ?>
          ...
          <div class="row g-4">
            <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2"><strong>Id Pengaju:</strong></label>
                <input type="text" class="form-control" name="idPengajuan" id="umum" value="<?php echo $auto_kode;?>" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-2">
                <label class="control-label col-sm-12 mb-2"><strong>RT KK:</strong></label>
            ...
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Provinsi KK:</strong></label>
                <input type="text" class="form-control" name="provinsiK" id="umum" value="<?php echo $data['provinsiK'];?>" required>
            </div>
             <div class="col-md-4">
                <label class="control-label col-sm-10 mb-2"><strong>Kabupaten KK:</strong></label>
                <input type="text" class="form-control" name="kabupatenK" id="umum" value="<?php echo $data['kabupatenK'];?>" required>
            </div>
             <div class="col-md-4">
                <label class="control-label col-sm-10 mb-2"><strong>Kecamatan KK:</strong></label>
                <input type="text" class="form-control" name="kecamatanK" id="umum" value="<?php echo $data['kecamatanK'];?>" required>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-10 mb-2"><strong>Kelurahan KK:</strong></label>
                <input type="text" class="form-control" name="kelurahanK" id="umum" value="<?php echo $data['kelurahanK'];?>" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Provinsi Domis:</strong></label>
                <input type="text" class="form-control" name="provinsiD" id="umum" value="<?php echo $data['provinsiD'];?>" required>
            </div>

             <div class="col-md-4">
                <label class="control-label col-sm-10 mb-2"><strong>Kabupaten Domis:</strong></label>
                <input type="text" class="form-control" name="kabupatenD" id="umum" value="<?php echo $data['kabupatenD'];?>" required>
            </div>

             <div class="col-md-4">
                <label class="control-label col-sm-10 mb-2"><strong>Kecamatan Domis:</strong></label>
                <input type="text" class="form-control" name="kecamatanD" id="umum" value="<?php echo $data['kecamatanD'];?>" required>
            </div>

             <div class="col-md-4">
                <label class="control-label col-sm-10 mb-2"><strong>Kelurahan KK:</strong></label>
                <input type="text" class="form-control" name="kelurahanD" id="umum" value="<?php echo $data['kelurahanD'];?>" required>
            </div>
        </div>
    </div>
        ...
        <div>
          ...
          <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="sumberListrik" class="form-control" value="<?php echo $data['sumberListrik'];?>">
            </div>
            <div class="col-md-4">
      ...
      <div style="width: 95%; height: 1100px; border-radius: 5px; background: #ecf0f1; padding:20px; margin:20px" >
        <div>
          ...
          <div class="row g-4">
            ...
            <div class="col-md-4" style="margin-bottom: 50px;">
                <label class="control-label col-sm-12 mb-2"><strong>Tanggal Pengajuan:</strong></label>
                <input type="text" class="form-control" name="tglPengajuan" id="umum" value="<?php echo $data['tglPengajuan'];?>" required>
                
            </div>
               <hr>
                <h3 style="font-size: 20px; margin:10px;">Upload Berkas</h3>
                <hr>
            </div>
            <div class="row g-4">
            <div class="col-md-6">
                <label class="control-label col-sm-12 mb-2"><strong>Foto KTP:</strong></label>
                <input type="text" class="form-control" name="nama" id="umum" value="<?php echo $data['nama'];?>" required><br>
                <?php echo "<img style='width: 100px; align: center;' src='gambar/$data[nama]' />";?>
                
            </div>
             <div class="col-md-6">
                <label class="control-label col-sm-12 mb-2"><strong>Foto KK:</strong></label>
                <input type="text" class="form-control" name="nama2" id="umum" value="<?php echo $data['nama2'];?>" required><br>
                <?php echo "<img style='width: 100px; align: center;' src='gambar/$data[nama2]' />";?>
                
            </div>
             <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2"><strong>Foto Pendaftar:</strong></label>
                <input type="text" class="form-control" name="nama3" id="umum" value="<?php echo $data['nama3'];?>" required><br>
                <?php echo "<img style='width: 100px; align: center;' src='gambar/$data[nama3]' />";?>
                
            </div>
             <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2"><strong>Foto Depan Rumah:</strong></label>
                <input type="text" class="form-control" name="nama4" id="umum" value="<?php echo $data['nama4'];?>" required><br>
                <?php echo "<img style='width: 100px; align: center;' src='gambar/$data[nama4]' />";?>
                
            </div>
             <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2"><strong>Foto Kamar Mandi:</strong></label>
                <input type="text" class="form-control" name="nama5" id="umum" value="<?php echo $data['nama5'];?>" required><br>
                <?php echo "<img style='width: 100px; height: 100px align: center;' src='gambar/$data[nama5]' />";?>
                
            </div>

            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2" hidden><strong>Tanggal Pengajuan:</strong></label>
                <input type="hidden" class="form-control" name="tglPengajuan" id="umum" value="<?php echo $data['tglPengajuan'];?>"><br>
                                
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2" hidden><strong>spv:</strong></label>
                <input type="text" class="form-control" name="status" id="umum" value="Proses" required><br>
                
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2" hidden><strong>managemen:</strong></label>
                <input type="text" class="form-control" name="statusM" id="umum" value="<?php echo $data['statusM'];?>" required><br>
                
                
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2" hidden><strong>admin:</strong></label>
                <input type="text" class="form-control" name="statusA" id="umum" value="Proses"><br>
                                
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2" hidden><strong>ket:</strong></label>
                <input type="text" class="form-control" name="catatan" id="umum" value="<?php echo $data['catatan'];?>" required><br>
                
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2" hidden><strong>ket:</strong></label>
                <input type="text" class="form-control" name="catatanM" id="umum" value="<?php echo $data['catatanM'];?>" required><br>
                
                
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-12 mb-2" hidden><strong>ket:</strong></label>
                <input type="text" class="form-control" name="catatanA" id="umum" value="<?php echo $data['catatanA'];?>"><br>
                                
            </div>
            <div class="col-sm-12 mt-5" style="margin-top:15px;">
                     <div class="form-group ml-4">
                        <button type="submit" name="btn_simpan" class="btn btn-success text-left ml-5">Ajukan</button>
