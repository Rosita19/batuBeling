...
<center><b>SISTEM ALMAAS SOSIAL</center>
<center><b>DATA ABSEN SOSIAL</center>
<hr><width="100" height="75"></hr>
<center>
    <h2>Anggota Kartu Subsidi 50%</h2>
</center>
<?php
include 'koneksi.php';
?>
          ...
          <table cellpadding="5" cellspacing="0" border="1" width="100%">
            ...
            <?php
           $sql = mysqli_query($konek, "select *from verifikasi where jenisBantuan = 'Subsidi 50%'");
           $no = 0;
