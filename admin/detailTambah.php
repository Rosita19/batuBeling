                     ...
                     <div class="panel" style="padding-bottom: 100px;">
                        ...
                        <div class="col-sm-12 mt-5">
                         <div class="col-sm-12 mt-5" style="margin:5px">
                            ...
                            $query = "select *from pengajuan order by idPengajuan DESC limit 1";
                            $sql = mysqli_query($konek, $query);
                            $data = mysqli_fetch_array($sql); 
                        ?> 
                            <div class="section-title">
                              <h3 class="text-center">Data Sukses Di Kirim!!</h3>
                              <center>
                                ...
                                <p style="font-size:20px; font-family:times new roman; color: red"><i>Anda Harus Menginputkan Data Anggota Keluarga sesuai jumlah anggota keluarga. Klik Lanjut!!</i></p>
                                <br>
                                <a href="anggotaTambah.php?idPengajuan=<?= $data['idPengajuan']?>" class="btn btn-success" style="margin-left: 40px; border-radius:5px">Lanjut</a>
                            </center>
                            </div>
