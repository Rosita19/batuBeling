                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Preview Gambar Bukti</h3>
                        </div>
                        <div class="col-sm-12 mt-5">
                         <div class="col-sm-12 mt-5" style="margin:20px">
                          <table>
                                        <tr>
                                            <td><a href="donasiLainA.php" style="margin-left : 40px; border-radius:5px;" class="btn btn-success">Kembali</a></td>
                        ...
                        <div>
                            <?php
                                    ...
                                    $query = "SELECT *FROM donasilain WHERE idDonasi = '".$idDonasi."'";
                                    $sql = mysqli_query($konek, $query);
                                    $data = mysqli_fetch_array($sql); 

                                    
                                    echo "<center><img style='width: 500px; margin:50px; align: center;' src='../admin/gambar/$data[gambar]' /></center>";
                            ?>
