                ...
                <div id="content-container">
                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        ...
                        <form action="proses_editKeluarga.php?idPengajuan=<?php echo $idPengajuan; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive">
                                         ...
                                         <table border="0" class="table table-striped" id="table1" > 
                                            ...
                                            <?php
                                                ...
                                                while($data1 = mysqli_fetch_array($sql1)){
                                                     ...
                                                     echo "<td><a class='btn btn-dark fa fa-edit' style='border-radius: 5px;' href='edit.php?idKeluarga=".$data1['idKeluarga']."'> </a></td>";
                                                     echo "<td><a class='btn btn-danger fa fa-trash' style='border-radius: 5px;' href='hapusKeluarga.php?idKeluarga=".$data1['idKeluarga']."'> </a></td>";
                                                      echo "<tr>";
                                                    }
                                                ?>
                                        </tr>
                                    ...
                                    <!-- <div class="col-md-12" style="margin-top:10px">
                                        ...
                                        <button type="submit" name="simpan" class="btn btn-success text-left ml-5">Simpan</button>
