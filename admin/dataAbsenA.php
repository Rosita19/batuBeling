                     ...
                     <div class="panel">
                            ...
                            <div style="width: 95%; border-radius: 5px; padding:20px; margin:20px" >
                                <div class="row g-4">
                                    ...
                                    <form action="dataAbsenA.php" method="get">
                                    <div class="col-md-6">
                             ...
                             <a href="dataAbsenA.php" class="btn btn-success fa fa-arrow-left" style="margin-left: 40px; border-radius:5px"></a>
                             <a href="tambahAbsen.php" class="btn btn-primary" style="margin-left: 5px;  margin-right: 20px; border-radius:5px;"><i class="fa fa-plus"></i> Add</a>
                            ...
                            if(isset($_GET['dari']) && isset($_GET['ke'])){
                                ...
                                $data = mysqli_query($konek, "SELECT * FROM absen WHERE tglAbsen BETWEEN '".$_GET['dari']."' and '".$_GET['ke']."'");
                            }else{
                                //jika tidak ada tanggal dari dan tanggal ke maka tampilkan seluruh data
                                 $data = mysqli_query($konek, "select *from absen");        
                            }
                        ...
                        <tr>
                            <td><?php echo $no++; ?></td>
                            <td><?php echo $d['namaPengaju']; ?></td>
                            <td><?php echo $d['ket']; ?></td>
                            <td><?php echo $d['tglAbsen']; ?></td>
                            <td><?php echo $d['status']; ?></td>
                            <td><?php echo $d['tahap']; ?></td>
                        </tr>
                        <?php } ?>
