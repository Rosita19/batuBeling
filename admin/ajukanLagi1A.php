...
<html lang="en">
                    ...
                    <div id="page-content">
                     <div class="panel" style="padding-bottom: 100px;">
                        <div class="panel-heading">
                            <h3 class="panel-title mb-5">Mengajukan Data Lagi</h3>
                            <?php
                                include "koneksi.php";
    ...
    <form action="proses_ajukan.php?idPengajuan=<?php echo $idPengajuan; ?>" method="post" enctype="multipart/form-data">  
        ...
        <div>
          ...
          <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <input type="date" class="form-control" name="tglLahir" id="datepicker" value="<?php echo $data['tglLahir'];?>" required>
            </div>
            <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2"><strong>Usia:</strong></label>
                <input type="number" class="form-control" name="usia" id="umur" value="<?php echo $data['usia'];?>" required>
            </div>
            <div class="col-md-4">
      ...
      <div style="width: 95%; height: 650px; border-radius: 5px; background: #ecf0f1; padding:20px; margin:20px" >
        <div>
          ...
          <div class="row g-4">
            ...
            <div class="col-sm-12 mt-5">
                     <div class="form-group ml-4">
                        ...
                        <a href="dataPending1A.php" class="btn btn-success">Batal</a>
                      </div>
                  </div>
        </div>
    </div>
