...
<body>
                                ...
                                <table border="0" class="table table-striped" id="table1" > 
                                        ...
                                        <tr>
                                            <td colspan="4"><?php echo "<center><img style='width: 200px; height: 150px; margin-top:10px; margin-left:10px; align: center;' src='../admin/gambar/$data[nama]' /></center>";?></td>
                                        </tr>
                                        <tr cellspa>
                                        ...
                                        <tr cellspa>
                                            ...
                                            <td colspan="4"><?php echo $data['makan'];?></td>
