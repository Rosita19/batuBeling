                    ...
                    <div id="page-content">
                     <div class="panel">
                            <div class="panel-heading" style="padding-bottom: 50px;">
                                <h3 class="panel-title">Data Pending Tahap 2</h3>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    // $query = "SELECT * FROM Pengajuan WHERE statusA = 'Pending Tahap 1'";
                                    $queri = "SELECT *FROM verifikasi WHERE jenisBantuan = 'Pending Tahap 2' And ajukan = 'Belum Diajukan'";
                                    ...
                                    while($data = mysqli_fetch_assoc($sql)){
                                      ...
                                      if ($data["jenisBantuan"] == 'Gratis'){
                                        ...
                                        }elseif ($data["jenisBantuan"] == 'Subsidi 50%') {
                                      ...
                                      echo "<td><a class='btn btn-danger fa fa-eye' style='border-radius: 5px;' href='tampilPengajuanA2.php?idVerif=".$data['idVerif']."'> </a></td>";
