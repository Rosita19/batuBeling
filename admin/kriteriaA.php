...
<html lang="en">
    ...
    <form action="proses_kriteria.php?idVerif=<?php echo $idVerif; ?>" method="post" enctype="multipart/form-data">  
    
      <div style="width: 95%; height: 400px; border-radius: 5px; background: #ecf0f1; padding:20px; margin:20px" >
        <div>
          ...
          <div class="row g-4">
          <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2"><strong>Tanggal Verifikasi:</strong></label>
                <input type="date" class="form-control" name="tglVerif" id="umum" value="<?php echo $data['tglVerif']; ?>" required>
            </div>
          <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2"><strong>Nama Surveyor:</strong></label>
                <input type="text" class="form-control" name="namaSurveyor" id="umum" value="<?php echo $data['namaSurveyor']; ?>" required>
          </div>
          <div class="col-md-4">
                <label class="control-label col-sm-8 mb-2"><strong>Nama Admin Input:</strong></label>
                <input type="text" class="form-control" name="namaAdmin" id="umum" value="<?php echo $data['namaAdmin'];?>" required>
          </div>
          	<div class="col-md-4">
            ...
            <div class="col-md-8">
                <label class="control-label col-sm-8 mb-2"><strong>Jenis Bantuan:</strong></label>
                <select class="form-control" name="jenisBantuan" required> 
                    <option>Pilih</option>
                    <option value="Pending Tahap 2">Pending Tahap 2</option>
                    <option value="Gratis">Gratis</option>
                    <option value="Subsidi 50%">Subsidi 50%</option>
                </select>
            </div>
            <div class="col-sm-12 mt-5" style="margin-top:15px;">
                     <div class="form-group ml-4">
                        <button type="submit" name="btn_simpan" class="btn btn-success text-left ml-5">Validasi</button>
                        <a href="tahap2A.php" class="btn btn-success">Batal</a>
                      </div>
                  </div>
        </div>
    </div>
